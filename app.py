...
<div class="tabs">
<button class="tab active" id="t1" ontouchend="sw(event,'video')" onclick="sw(event,'video')">📹 Video Downloader</button>
<button class="tab" id="t2" ontouchend="sw(event,'tts')" onclick="sw(event,'tts')">🎙 Text to Audio</button>
</div>
...
<button class="bfetch" id="fb" type="button" ontouchend="fi()" onclick="fi()">Fetch</button>
</div>
...
<button class="bdl" id="db" type="button" ontouchend="dl()" onclick="dl()">⬇ Download</button>
...
<button class="btts" id="tb" type="button" ontouchend="tt()" onclick="tt()">🎙 Convert to Audio</button>
...
<script>
const MAX=3000;
function sw(e,t){document.getElementById('t1').classList.toggle('active',t==='video');document.getElementById('t2').classList.toggle('active',t==='tts');document.getElementById('pv').classList.toggle('active',t==='video');document.getElementById('pt2').classList.toggle('active',t==='tts');}
